    ...
    return (
      <div>
        <div className="input-block">
          ...
          {/* <input type="checkbox" name="maleCheck" id="maleCheck" checked className="input-checkbox" />
          <label htmlFor="maleCheck">Male</label>
          <input type="checkbox" name="femaleCheck" id="femaleCheck" checked className="input-checkbox" />
          <label htmlFor="femaleCheck">Female</label>
          <input type="checkbox" name="anonCheck" id="anonCheck" checked className="input-checkbox" />
          <label htmlFor="anonCheck">Anonymous</label> */}
        </div>
